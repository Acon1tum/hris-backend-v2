...
async function main() {
  ...
  const hrPermissions = [
    ...
    'leave_request_read', 'leave_request_update',
    'recruitment_read', 'recruitment_create', 'recruitment_update',
    'payroll_record_read', 'payroll_record_create',
    'performance_review_read', 'performance_review_create',
  ...
  const employeePermissions = [
    'employee_read',
    'leave_request_create', 'leave_request_read',
    'attendance_log_create', 'attendance_log_read',
